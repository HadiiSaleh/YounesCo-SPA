...
export class AccountService {
    ...
    private baseUrlForgotPassword: string = environment.apiUrl + "accounts/forgotpassword";
    private baseUrlResetPassword: string = environment.apiUrl + "accounts/resetpassword";
    private baseUrlGetUserByUsername: string = environment.apiUrl + "accounts/GetUserByUsername";
    private baseUrlGetUserById: string = environment.apiUrl + "accounts/GetUserById";
    private baseUrlUpdateUserById: string = environment.apiUrl + "accounts/UpdateUserById";
    ...
    rememberMyUserName(username: string, option: boolean) {
        ...
        if (option == true) localStorage.setItem('rememberUserName', username)
