...
var HeaderOneItems = [
  ...
  // Need to change the image of categories and see if i can add an image to be shown to each category
  // {
  //   state: 'products/mobile-accessories',
...
export class MenuItems {
  ...
  //   categories: Menu =
  //     {
  //       state: 'products/bathroom',
  //       name: 'BATHROOM',
  //       type: 'sub',
  //       icon: 'perm_contact_calendar',
  //       children: [
  //         {
  //         state: 'bath-accessories',
  //         name: 'Bathroom accessories',
  //         queryState: 'bathroom-accessories',
  //         type: 'queryParams',
  //         icon: 'arrow_right_alt'
  //           },
  //         {
